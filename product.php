			...
			<div class="row details_row">
				...
				<div class="col-lg-6">
					<div class="details_image">
						<div class="details_image_large"><img src="images/details_1.jpg" alt=""><div class="product_extra product_new"><a href="categories.html">Nuevo</a></div></div>
						<div class="details_image_thumbnails d-flex flex-row align-items-start justify-content-between">
							<?php for($i=1;$i<=4;$i++){ ?>
							<div class="details_image_thumbnail <?php if($i==1){echo "active";} ?>" data-image="images/details_<?php echo $i?>.jpg">
								<img src="images/details_<?php echo $i?>.jpg" alt="">
							</div>
							<?php } ?>
						</div>
					</div>
				...
				<div class="col-lg-6">
					<div class="details_content">
						...
						<div class="details_discount"><?php$rand(1000, 999);?></div>
						<div class="details_price"><?php$rand(1000, 999);?></div>
						...
						<div class="product_quantity_container">
							...
							<div class="button cart_button"><a href="#">Agregar al carrito</a></div>
						</div>
			...
			<div class="row description_row">
				<div class="col">
					<div class="description_title_container">
						...
						<div class="reviews_title"><a href="#">Vistas <span>(1)</span></a></div>
					</div>
