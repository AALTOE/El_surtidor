				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo"><a href="index.php">El surtidor</a></div>
							<nav class="main_nav">
								<ul>
		...
		<div class="menu_container menu_mm">
			<div class="page_menu_content">
				...
				<div class="page_menu_search menu_mm">
					<form action="#">
						<input type="search" required="required" class="page_menu_search_input menu_mm" placeholder="Buscando productos...">
					</form>
				</div>
				<ul class="page_menu_nav menu_mm">
					<li class="page_menu_item has-children menu_mm">
						...
						<ul class="page_menu_selection menu_mm">
							...
							<li class="page_menu_item menu_mm"><a href="product.php">Productos<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="cart.php">Carrito<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="checkout.php">Checkout<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="contact.php">Contacto<i class="fa fa-angle-down"></i></a></li>
						</ul>
					</li>
					<li class="page_menu_item has-children menu_mm">
					...
					<li class="page_menu_item menu_mm"><a href="index.php">Accesorios<i class="fa fa-angle-down"></i></a></li>
